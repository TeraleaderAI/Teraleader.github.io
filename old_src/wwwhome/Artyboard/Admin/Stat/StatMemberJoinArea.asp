              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="35"><img src="../images/main_title30.gif" width="147" height="19"></td>
                      <td align="right">관리자 홈 &gt; 통계자료 &gt; <b>거주지역별 회원통계</b></td>
                    </tr>
                  </table>
								</td>
              </tr>
...
%>
					...
					<table width="100%"  border="0" cellpadding="0" cellspacing="0">
						...
						<tr align="center" bgcolor="EB766F">
						  <td width="140" nowrap class="table_Txt1">지역</td>
...
<%
	...
	SET RS = DBCON.EXECUTE("SELECT [strSIDO], COUNT([strSIDO]) AS [intCount] FROM [MPLUS_MEMBER_LIST] WHERE [bitSecession] = '0' " & Query & " GROUP BY [strSIDO] ORDER BY [strSIDO] ASC ")
...
%>
						<tr bgcolor="#FFFFFF" align="center">
						  <td align="center" class="table_ListSubText1"><%=RS("strSIDO")%></td>
							...
							<tr>
								<td style="padding:10 10 10 10">
									...
									<table width="100%"  border="0" cellspacing="10" cellpadding="0">
										<tr>
											<td>
											<LI>다양한 검색조건을 이용해서 거주지역별 회원가입 통계를 확인할 수 있습니다.</LI>
											<LI>거주지역은 자택주소를 기준으로 통계를 처리합니다.</LI>
											<LI>거주지역별 통계를 확인하시려면 회원가입 항목설정에서 <font color="#FD8402"><b>자택주소</b></font>를 필수로 입력받아야 합니다.</LI></td>
										</tr>
									</table>
									</fieldset>
								</td>
...
<script language="javascript">
	...
	function OnStatSearch(){
		document.theForm.action = "StatMemberJoinArea.asp";
