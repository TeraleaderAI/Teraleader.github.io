...
<% IF CMT_REDIM_intDepth(CMT_LIST) > 0 THEN %>
														<td width="15"></td>
<% END IF %>
														<td class="pdt10 pdb10" style="word-break:break-all; line-height:18px;"><%=CMT_REDIM_strContent(CMT_LIST)%></td>
													</tr>
												</table>
											</td>
										</tr>
