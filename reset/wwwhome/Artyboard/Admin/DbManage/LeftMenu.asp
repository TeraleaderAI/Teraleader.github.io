                    ...
                    <tr>
                      <td align="center" background="../images/left_m_bg.gif">
                        <table width="162" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="37" style="padding-left:6"><img src="../images/left_m_tit7.gif" width="74" height="23"></td>
                          </tr>
                          <tr>
                            ...
                            <td style="padding:9 0 9 8">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td height="20"><a href="DbTableList.asp"><span class="leftMenu<% IF intLeftMenu = 1 THEN %>On<% END IF %>">데이타베이스 정보</span></a></td>
                                </tr>
                                <tr>
                                  <td><img src="../images/left_m_icon.gif" width="10" height="11"></td>
                                  <td height="20"><a href="DbInsertMember.asp"><span class="leftMenu<% IF intLeftMenu = 2 THEN %>On<% END IF %>">EXCEL 회원DB등록</span></a></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
