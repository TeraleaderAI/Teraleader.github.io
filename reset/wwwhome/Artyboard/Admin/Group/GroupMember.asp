    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="450" height="458" align="center" valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="476" valign="top"><iframe name="GroupMemberList" src="GroupMemberList.asp?strGroupCode=<%=strGroupCode%>" width="450" height="476" frameborder="0" scrolling="no"></iframe></td>
          </tr>
        </table></td>
        <td width="450" height="458" align="center" valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
					<tr>
          ...
          <tr>
            <td height="476" valign="top"><iframe name="GroupMemberSearchList" src="GroupMemberSearchList.asp?strGroupCode=<%=strGroupCode%>" width="450" height="476" frameborder="0" scrolling="no"></iframe></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
