...
<%
	...
	strTempSkin = GetFolderList(rootPath & "Skin\Poll\", strSkin, "file")
	IF strTempSkin = "" THEN
		strNowSkinIMG = "<img id=skinPrev src=../images/skin_not_image.gif width=160 height=120 align=absmiddle border=0>"
	ELSE
		IF GetFileExists(rootPath & "Skin\Poll\" & strSkin & "\", "preview.jpg") = True THEN strNowSkinIMG = "<img id=skinPrev src=../../Skin/Poll/" & strSKin & "/preview.jpg width=160 height=120 align=absmiddle border=0>" ELSE strNowSkinIMG = "<img id=skinPrev src=../images/skin_not_image.gif width=160 height=120 align=absmiddle border=0>"
...
<%
	FOR I = 0 TO UBOUND(strTempSkin)
		IF strTempSkin(I) <> "" THEN
			IF GetFileExists(rootPath & "Skin\Poll\" & strTempSkin(I) & "\", "preview.jpg") = True THEN
				RESPONSE.WRITE "	arrSkinPrev[" & I & "] = ""../../Skin/Poll/" & strTempSkin(I) & "/preview.jpg"";" & vbcrlf
				RESPONSE.WRITE "	arrSkinPrevZoom[" & I & "] = """ & httpPath & "Skin/Poll/" & strTempSkin(I) & "/preview.jpg"";" & vbcrlf
			ELSE
...
<% END IF %>
						<table width="750" border="0" cellspacing="0" cellpadding="0">
							<form name="theForm" method="post" action="PollDefaultConfig_ok.asp" onSubmit="return OnSubmitAction();">
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="35"><img src="../images/main_title46.gif" width="134" height="19"></td>
                      <td align="right">관리자 홈 &gt; 기타관리 &gt; <b>설문조사 환경설정</b></td>
                    </tr>
                  </table>                </td>
              </tr>
              <tr>
                ...
                <td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<%=GetFolderList(rootPath & "Skin\Poll\", strSkin, "skin")%>
              ...
              <tr>
                <td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td class="table_Left1">상단/하단 파일사용</td>
											<td class="table_Right1"><input name="strUseHeadTailFile1" type="checkbox" id="strUseHeadTailFile1" value="1"<% IF strUseHeadTailFile(0) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailFile1" style="cursor:hand">설문조사목록</LABEL>
											<input name="strUseHeadTailFile2" type="checkbox" id="strUseHeadTailFile2" value="1"<% IF strUseHeadTailFile(1) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailFile2" style="cursor:hand">설문조사실행</LABEL>
											<input name="strUseHeadTailFile3" type="checkbox" id="strUseHeadTailFile3" value="1"<% IF strUseHeadTailFile(2) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailFile3" style="cursor:hand">설문조사결과</LABEL></td>
										</tr>
										<tr>
											<td colspan="2" height="1" bgcolor="#EFEFEF"></td>
										</tr>
										<tr>
											<td class="table_Left1">상단/하단 HTML사용</td>
											<td class="table_Right1"><input name="strUseHeadTailText1" type="checkbox" id="strUseHeadTailText1" value="1"<% IF strUseHeadTailText(0) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailText1" style="cursor:hand">설문조사목록</LABEL>
											<input name="strUseHeadTailText2" type="checkbox" id="strUseHeadTailText2" value="1"<% IF strUseHeadTailText(1) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailText2" style="cursor:hand">설문조사실행</LABEL>
											<input name="strUseHeadTailText3" type="checkbox" id="strUseHeadTailText3" value="1"<% IF strUseHeadTailText(2) = "1" THEN %> CHECKED<% END IF %> class="no_Line"><LABEL FOR="strUseHeadTailText3" style="cursor:hand">설문조사결과</LABEL></td>
										</tr>
										<tr>
											<td colspan="2" height="1" bgcolor="#EFEFEF"></td>
										</tr>
							...
							<tr>
								<td style="padding:10 10 10 10">
									...
									<table width="100%"  border="0" cellspacing="10" cellpadding="0">
										<tr>
											<td>
											<LI>설문조사에 필요한 기본 기능설정을 설정하실 수 있으며, 다양한 스킨을 선택하실 수 있습니다.</LI>
											<LI>설문조사 항목은 좌측의 설문조사 리스트 페이지에서 설정하실 수 있습니다.</LI>
											</td>
										</tr>
									</table>
									</fieldset>
