              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="35"><img src="../images/main_title34.gif" width="134" height="19"></td>
                      <td align="right">관리자 홈 &gt; 통계자료 &gt; <b>시간대별 접속통계</b></td>
                    </tr>
                  </table>
								</td>
              </tr>
...
<%
	SET RS = DBCON.EXECUTE("EXEC [MPLUS_GET_STAT] '4', '" & sDateS & "', '" & sDateE & "' ")
...
%>
										<tr bgcolor="#FFFFFF" align="center">
											<td align="center" class="table_ListSubText1"><%=RS("strConnDate")%> 시</td>
							...
							<tr>
								<td style="padding:10 10 10 10">
									...
									<table width="100%"  border="0" cellspacing="10" cellpadding="0">
										<tr>
											<td>
											<LI>검색 기간내에 접속 정보를 시간대별로 구분지어 통계를 확인할 수 있습니다.</LI>
											</td>
										</tr>
									</table>
									</fieldset>
...
<script language="javascript">
	...
	function OnStatSearch(){
		document.theForm.action = "StatSiteHour.asp";
