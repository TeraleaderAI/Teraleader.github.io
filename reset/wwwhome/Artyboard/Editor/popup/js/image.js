...
function init(dialog) {
	...
	UploadScript = oEditor.config.editorPath + 'imageUpload/upload.asp?strPath=' + parent.SET_Editor_FilePath;
	DeleteScript = oEditor.config.editorPath + 'imageUpload/remove.asp';
...
//		create_request_object(DeleteScript + '?img=' + self.firstChild.src);
		create_request_object(DeleteScript + '?img=' + self.firstChild.src + '&strPath=' + parent.parent.SET_Editor_FilePath);
...
//				create_request_object(DeleteScript + '?img=' + img.firstChild.src);
				create_request_object(DeleteScript + '?img=' + img.firstChild.src + '&strPath=' + parent.parent.SET_Editor_FilePath);
