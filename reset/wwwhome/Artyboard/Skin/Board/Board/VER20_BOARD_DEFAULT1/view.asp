...
<% IF CONF_bitUseUpload = True AND READ_intFileCount > 0 THEN %>
	<tr>
		<td class="pdt10 pdb10 viewLine6">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26" class="pdl5 pdr5">현재 게시글에 <b><%=READ_intFileCount%></b> 개의 파일이 첨부되어 있습니다.</td>
				</tr>
				<tr>
					<td class="pda5"><!-- #include file = "fileList.asp" --></td>
				</tr>
			</table>
		</td>
	</tr>
