			...
			<table width="300" border="0" cellspacing="1" cellpadding="0" bgcolor="#DFDFDF">
				<tr>
					<td bgcolor="#FFFFFF" style="padding:10px 10px 10px 10px">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="30" style="font-size:16px"><b>댓글 삭제</b></td>
							</tr>
							<tr>
...
<% END SELECT %>
							...
							<tr>
								...
								<% IF strCmtDeleteMode <> "0" THEN %><input type="image" name="imageField" id="imageField" src="<%=skinPath%>images/btn_delete2.gif" class="no_Line"><% END IF %>
								<a href="<%=CMT_BackLink%>"><img src="<%=skinPath%>images/btn_back.gif" width="82" height="23" border="0"></a></td>
							</tr>
						</table>
					</td>
				</tr>
